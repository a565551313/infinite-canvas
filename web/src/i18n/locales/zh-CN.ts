export default {
    ...
    imageWorkbench: {
        ...
        optimizeTitle: "优化提示词",
        optimizeModel: "文本模型",
        optimizeSource: "当前提示词",
        optimizeResult: "优化结果",
        optimizeResultEmpty: "选择文本模型后，点击「开始优化」改写当前提示词",
        optimizeStart: "开始优化",
        optimizeRetry: "重新优化",
        optimizeStop: "停止",
        optimizeReplace: "替换提示词",
        optimizeReplaced: "已替换为优化后的提示词",
        optimizeSystemPrompt:
            "你是一名专业的 AI 绘画提示词优化专家。请把用户提供的生图提示词改写得更具体、更有画面感，可以补充主体细节、风格、构图、视角、光线、色彩和氛围，但不要改变用户的原始意图。只输出优化后的提示词正文，不要添加解释、标题、前后缀或引号，保持与原文相同的语言。",
    },
    videoWorkbench: {
        title: "视频创作台",
    ...
    topNav: {
        ...
        lightTheme: "切换到浅色主题",
        darkTheme: "切换到深色主题",
        userMenu: { login: "登录 / 注册", account: "个人中心", admin: "管理后台", signOut: "退出登录" },
    },
    home: {
        promptError: "获取提示词失败",
    ...
    version: {
        ...
        customVersion: "定制版本",
        customLatest: "最新定制版本",
        customNewAvailable: "有新定制版本",
        newAvailable: "有新版本",
        upstreamBaseline: "上游基线",
        customChangelogTab: "定制日志",
        upstreamChangelogTab: "上游日志",
        checkCustomUpdates: "检查定制更新",
        checkUpstreamUpdates: "检查上游更新",
        customReadFailed: "定制版本读取失败",
        customUpdateFailed: "获取定制版本信息失败",
        customUpToDate: "定制版本已是最新",
        customNewFound: "发现新定制版本 {{version}}",
        empty: "暂无更新记录",
    },
    config: {
        title: "配置与用户偏好",
        ...
        about: {
            appearance: "外观与语言",
            appearanceDescription: "设置界面语言和主题，修改后立即生效。",
            language: "界面语言",
            theme: "主题",
            themeLight: "浅色",
            themeDark: "深色",
            version: "版本",
            versionDescription: "对比当前运行版本与最新版本，可查看完整更新日志。",
            viewChangelog: "查看更新日志",
            resources: "文档与开源",
            resourcesDescription: "查阅使用文档，或前往 GitHub 查看项目源码。",
            docs: "使用文档",
            github: "GitHub 仓库",
        },
        proxy: {
            ...
            sameOriginMissing: "当前站点未部署 /api/proxy 跨域转发接口，botcf.com 这类不支持跨域的模型服务必须靠本地代理转发。",
            enableNow: "开启本地代理",
        },
        localStorage: {
    ...
    auth: {
        ...
        demoAdmin: "以管理员身份体验（演示）",
        submitLogin: "登录",
        submitRegister: "创建账号",
        invalidEmail: "邮箱格式不正确",
        passwordTooShort: "密码至少 8 位",
        passwordMismatch: "两次输入的密码不一致",
        demoNotice: "当前为界面演示：不会真的创建账号，也不会发送任何请求。",
    },
    account: {
        title: "个人中心",
        description: "账号资料、积分余额与消费流水",
        profile: "账号资料",
        email: "邮箱",
        role: "角色",
        roleUser: "普通用户",
        ...
        ledger: "积分流水",
        ledgerEmpty: "暂无流水",
        columns: { at: "时间", type: "类型", delta: "变动", balance: "余额", reason: "说明" },
        types: { grant: "赠送", consume: "消费", redeem: "兑换", refund: "退款" },
        subscription: "订阅与套餐",
        vipActive: "VIP 生效中",
        vipUntil: "{{date}} 到期",
        upgrade: "升级 VIP（暂未开放）",
    ...
    admin: {
        title: "管理后台",
        description: "用户、积分、平台渠道与运营数据",
        backToSite: "返回主站",
        menu: { users: "用户管理", credits: "积分与兑换码", channels: "平台渠道", dashboard: "数据看板" },
        users: {
            search: "搜索邮箱或昵称",
            columns: { user: "用户", role: "角色", credits: "积分", vip: "VIP", status: "状态", calls: "30 天调用", lastActive: "最近活跃" },
            statusActive: "正常",
            statusBanned: "已封禁",
            actions: { detail: "详情", adjust: "调整积分", ban: "封禁", unban: "解封" },
            adjustTitle: "调整积分",
            adjustDelta: "变动数量",
            adjustReason: "原因（必填）",
            adjustReasonPlaceholder: "例如：活动赠送 / 补偿",
            adjustPositive: "正数增加，负数扣减",
            adjustSubmit: "确认调整",
            detailTitle: "用户详情",
            auditHint: "所有积分变动都会写入流水与审计日志，禁止直接改余额。",
        },
        credits: {
            columns: { code: "兑换码", credits: "面值", usage: "使用情况", expires: "有效期", createdBy: "创建人", status: "状态" },
            statusActive: "可用",
            statusUsedUp: "已用完",
            statusExpired: "已过期",
            generate: "生成兑换码",
            generatedTitle: "已生成 {{count}} 张，点击复制",
            genCount: "生成数量",
            genValue: "每张面值",
            genMaxUses: "单码可用次数",
            genExpiryDays: "有效天数",
            genSubmit: "生成",
            genHint: "生成后可复制发给朋友；使用记录计入积分流水。",
            copied: "已复制",
        },
        channels: {
            add: "新增渠道",
            columns: { name: "渠道", models: "模型与单价", enabled: "启用", calls: "30 天调用", cost: "30 天积分消耗" },
            edit: "编辑",
            test: "测试",
            testOk: "连接成功（演示）",
            apiKeyHint: "密钥加密存储，界面仅显示掩码，永不下发到浏览器。",
            fields: { name: "渠道名称", baseUrl: "Base URL", apiKey: "API Key", current: "当前", apiKeyKeep: "留空表示不修改", models: "模型与单价", addModel: "添加模型" },
            modelColumns: { model: "模型", price: "单价" },
            units: { token: "1K token", image: "张", second: "秒" },
        },
        dashboard: {
            cards: { dau: "日活跃用户", calls: "今日调用", credits: "今日积分消耗", failRate: "失败率" },
            vsYesterday: "较昨日",
            trend: "近 7 天调用趋势",
            byModel: "按模型调用分布",
            topUsers: "积分消耗 Top",
