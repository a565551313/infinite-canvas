export default {
    ...
    imageWorkbench: {
        ...
        optimizeModel: "Text model",
        optimizeSource: "Current prompt",
        optimizeResult: "Optimized result",
        optimizeResultEmpty: "Pick a text model, then click “Optimize” to rewrite the current prompt.",
        optimizeStart: "Optimize",
        optimizeRetry: "Retry",
        optimizeStop: "Stop",
        optimizeReplace: "Replace prompt",
        optimizeReplaced: "Prompt replaced with the optimized version",
        optimizeSystemPrompt:
            "You are an expert AI image-prompt optimizer. Rewrite the user's image prompt to be more specific and vivid; you may add subject details, style, composition, camera angle, lighting, color, and atmosphere without changing the original intent. Output only the optimized prompt text, with no explanations, headings, prefixes, suffixes, or quotes, in the same language as the input.",
    },
    videoWorkbench: {
        title: "Video Studio",
    ...
    topNav: {
        ...
        userMenu: { login: "Sign in / Sign up", account: "Account", admin: "Admin", signOut: "Sign out" },
    },
    home: {
    ...
    version: {
        ...
        customLatest: "Latest custom version",
        customNewAvailable: "Custom update available",
        newAvailable: "Update available",
        upstreamBaseline: "Upstream baseline",
        customChangelogTab: "Custom changelog",
        upstreamChangelogTab: "Upstream changelog",
        checkCustomUpdates: "Check custom updates",
        checkUpstreamUpdates: "Check upstream updates",
        customReadFailed: "Failed to read the custom version",
        customUpdateFailed: "Failed to load the custom version information",
        customUpToDate: "The custom version is up to date",
        customNewFound: "New custom version found: {{version}}",
    ...
    config: {
        ...
        about: {
            ...
            appearanceDescription: "Set the interface language and theme. Changes apply immediately.",
            language: "Interface language",
            theme: "Theme",
            themeLight: "Light",
            themeDark: "Dark",
            version: "Version",
            versionDescription: "Compare the running version with the latest release and view the full changelog.",
            viewChangelog: "View release notes",
            resources: "Docs & open source",
            resourcesDescription: "Read the documentation, or browse the source code on GitHub.",
            docs: "Documentation",
        ...
        proxy: {
            ...
            sameOriginMissing: "This site has no same-origin /api/proxy relay, so providers that block cross-origin browser calls, such as botcf.com, only work through the local proxy.",
            enableNow: "Turn on the local proxy",
        },
        localStorage: {
    ...
    auth: {
        ...
        subtitle: "Sign in to sync canvases, use platform providers and credits",
        login: "Sign in",
        register: "Sign up",
        email: "Email",
        password: "Password",
        ...
        demoAdmin: "Experience as admin (demo)",
        submitLogin: "Sign in",
        submitRegister: "Create account",
        invalidEmail: "Invalid email format",
        passwordTooShort: "Password must be at least 8 characters",
        passwordMismatch: "Passwords do not match",
        demoNotice: "Demo only: no account will be created and no request will be sent.",
    },
    account: {
        title: "Account",
        description: "Profile, credits balance and ledger",
        profile: "Profile",
        email: "Email",
        role: "Role",
        roleUser: "User",
        ...
        redeemSubmit: "Redeem",
        ledger: "Ledger",
        ledgerEmpty: "No records",
        columns: { at: "Time", type: "Type", delta: "Change", balance: "Balance", reason: "Reason" },
        types: { grant: "Grant", consume: "Consume", redeem: "Redeem", refund: "Refund" },
        subscription: "Subscription",
        vipActive: "VIP active",
        vipUntil: "Until {{date}}",
        upgrade: "Upgrade VIP (coming soon)",
    },
    admin: {
        title: "Admin",
        description: "Users, credits, providers and metrics",
        backToSite: "Back to site",
        menu: { users: "Users", credits: "Credits & codes", channels: "Providers", dashboard: "Dashboard" },
        users: {
            search: "Search email or name",
            columns: { user: "User", role: "Role", credits: "Credits", vip: "VIP", status: "Status", calls: "Calls 30d", lastActive: "Last active" },
            statusActive: "Active",
            statusBanned: "Banned",
            actions: { detail: "Detail", adjust: "Adjust", ban: "Ban", unban: "Unban" },
            adjustTitle: "Adjust credits",
            adjustDelta: "Delta",
            adjustReason: "Reason (required)",
            adjustReasonPlaceholder: "e.g. promotion / compensation",
            adjustPositive: "Positive to add, negative to deduct",
            adjustSubmit: "Confirm",
            detailTitle: "User detail",
            auditHint: "All credit changes are written to ledger and audit logs; do not edit balance directly.",
        },
        credits: {
            columns: { code: "Code", credits: "Value", usage: "Usage", expires: "Expires", createdBy: "Created by", status: "Status" },
            statusActive: "Active",
            statusUsedUp: "Used up",
            statusExpired: "Expired",
            generate: "Generate codes",
            generatedTitle: "Generated {{count}}, click to copy",
            genCount: "Count",
            genValue: "Value each",
            genMaxUses: "Max uses",
            genExpiryDays: "Expiry days",
            genSubmit: "Generate",
            genHint: "Copy and share with friends; usage is recorded in ledger.",
            copied: "Copied",
        },
        channels: {
            add: "Add provider",
            columns: { name: "Provider", models: "Models & price", enabled: "Enabled", calls: "Calls 30d", cost: "Cost 30d" },
            edit: "Edit",
            test: "Test",
            testOk: "Connection ok (demo)",
            apiKeyHint: "Keys are encrypted; UI shows masked value only and never sends it to browser.",
            fields: { name: "Provider name", baseUrl: "Base URL", apiKey: "API Key", current: "Current", apiKeyKeep: "Leave empty to keep", models: "Models & price", addModel: "Add model" },
            modelColumns: { model: "Model", price: "Price" },
            units: { token: "1K tokens", image: "image", second: "sec" },
        },
        dashboard: {
            cards: { dau: "DAU", calls: "Calls today", credits: "Credits today", failRate: "Fail rate" },
            vsYesterday: "vs yesterday",
            trend: "Calls trend (7 days)",
            byModel: "Calls by model",
            topUsers: "Top users by credits",
            callsUnit: "calls",
            creditsUnit: "credits",
        },
    },
